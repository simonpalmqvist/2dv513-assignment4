...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DangerButton = __webpack_require__(3);
	
	var _DangerButton2 = _interopRequireDefault(_DangerButton);
	
	var _Recipe = __webpack_require__(4);
	...
	var Main = function (_Component2) {
	  ...
	  function Main() {
	    ...
	    _this2._showRecipe = _this2._showRecipe.bind(_this2);
	    return _this2;
	  }
	  ...
	  _createClass(Main, [{
	    ...
	    value: function render() {
	      ...
	      if (this.state.showRecipe) {
	        show = (0, _preact.h)(_Recipe2.default, null);
	      }
	      ...
	      return (0, _preact.h)(
	        ...
	        { style: wrapper },
	        show,
	        (0, _preact.h)(Loading, { loading: this.state.loading })
	      );
	    }
	  }]);
	        ...
	        (0, _preact.h)(
	          ...
	          (0, _preact.h)(
	            ...
	            (0, _preact.h)(
	              ...
	              '\u201DPassar perfekt till en flaska r\xF6dtjut!\u201D'
	            )
	          )
	        ),
	        (0, _preact.h)(
	        ...
	        (0, _preact.h)(
	          ...
	          (0, _preact.h)(
	            ...
	            (0, _preact.h)(
	              'li',
	              { style: liStyle },
	              'Sk\xE4r bacon i strimlor och finhacka l\xF6ken.'
	            ),
	            (0, _preact.h)(
	              'li',
	              { style: liStyle },
	              'Koka upp vatten med salt och sl\xE4ng sedan i pastan.'
	            ),
	            (0, _preact.h)(
	              'li',
	              { style: liStyle },
	              'Stek baconet & l\xF6ken gyllenbrun, blanda sedan i gr\xE4dden & \xE4ggvitan. Smaks\xE4tt med salt & peppar.'
	            ),
	            (0, _preact.h)(
	              'li',
	              { style: liStyle },
	              'Blanda ihop allting och servera med de kvarvarande \xE4ggulorna p\xE5.'
	            )
	          )
	        )
	      );
