...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _preact.render)((0, _preact.h)(_Main2.default, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DangerButton = __webpack_require__(4);
	...
	var _Recipe = __webpack_require__(6);
	...
	var Main = function (_Component) {
	  ...
	  function Main() {
	    ...
	    _this.user = localStorage.getItem('user_id');
	    ...
	    _this._showRecipe = _this._showRecipe.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Main, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      if (this.user) {
	        fetch('/api/recipe?user=' + this.user).then(function (response) {
	    ...
	    key: '_fetchUser',
	    value: function _fetchUser() {
	      var _this3 = this;
	
	      fetch('/api/user').then(function (response) {
	        return response.json();
	      }).then(function (json) {
	        return _this3.user = json.user;
	      }).then(function () {
	        return localStorage.setItem('user_id', _this3.user);
	      });
	    }
	  }, {
	    key: '_showRecipe',
	    value: function _showRecipe() {
	      var _this4 = this;
	
	      this.setState({ loading: true });
	
	      fetch('/api/recipe/new?user=' + this.user).then(function (response) {
	        return response.json();
	      }).then(function (json) {
	    ...
	    value: function render() {
	      ...
	      var show = (0, _preact.h)(
	        'div',
	        { style: center },
	        (0, _preact.h)(_DangerButton2.default, { onClick: this._showRecipe })
	      );
	
	      if (this.state.showRecipe) {
	        show = (0, _preact.h)(_Recipe2.default, { recipe: this.state.recipe });
	      }
	      ...
	      return (0, _preact.h)(
	        ...
	        { style: wrapper },
	        show,
	        (0, _preact.h)(_Loading2.default, { loading: this.state.loading })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DangerButton = function (_Component) {
	  _inherits(DangerButton, _Component);
	
	  function DangerButton() {
	    _classCallCheck(this, DangerButton);
	
	    var _this = _possibleConstructorReturn(this, (DangerButton.__proto__ || Object.getPrototypeOf(DangerButton)).call(this));
	
	    _this._handleClick = _this._handleClick.bind(_this);
	    _this._animationDone = _this._animationDone.bind(_this);
	    _this.state = {
	      clicked: false
	    };
	    return _this;
	  ...
	  _createClass(DangerButton, [{
	    ...
	    value: function render() {
	      ...
	      return (0, _preact.h)(
	        'div',
	        { style: buttonStyle },
	        (0, _preact.h)('div', { style: buttonBottomShadowStyle }),
	        (0, _preact.h)('div', { style: buttonBottomStyle }),
	        (0, _preact.h)('div', { style: buttonBodyStyle }),
	        (0, _preact.h)('button', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PaperList = __webpack_require__(7);
	
	var _PaperList2 = _interopRequireDefault(_PaperList);
	
	var _RecipeHeader = __webpack_require__(8);
	  ...
	  _createClass(Recipe, [{
	    ...
	    value: function render() {
	      ...
	      var instructions = recipe.instructions.map(function (i) {
	        return i.step + '. ' + i.description;
	      });
	
	      return (0, _preact.h)(
	        'div',
	        { style: containerStyle },
	        (0, _preact.h)('div', { style: headerStyle }),
	        (0, _preact.h)(_RecipeHeader2.default, {
	          name: recipe.name,
	          tag: recipe.tag,
	          image: recipe.image }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PaperList = function (_Component) {
	  _inherits(PaperList, _Component);
	
	  function PaperList() {
	    _classCallCheck(this, PaperList);
	
	    return _possibleConstructorReturn(this, (PaperList.__proto__ || Object.getPrototypeOf(PaperList)).apply(this, arguments));
	  }
	  ...
	  _createClass(PaperList, [{
	    ...
	    value: function render() {
	      ...
	      var list = items.map(function (item, i) {
	        ...
	        if (i === last) {
	          liStyle.borderBottom = 'none', liStyle.paddingBottom = '25px';
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecipeHeader = function (_Component) {
	  _inherits(RecipeHeader, _Component);
	
	  function RecipeHeader() {
	    _classCallCheck(this, RecipeHeader);
	
	    return _possibleConstructorReturn(this, (RecipeHeader.__proto__ || Object.getPrototypeOf(RecipeHeader)).apply(this, arguments));
	  }
	  ...
	  _createClass(RecipeHeader, [{
	    ...
	    value: function render() {
	      ...
	      return (0, _preact.h)(
	        'div',
	        { style: headStyle },
	        (0, _preact.h)('div', { style: recipeImage }),
	        ...
	        (0, _preact.h)(
	          ...
	          (0, _preact.h)(
	            'h2',
	            { style: { fontSize: '2.2em', textShadow: '1px 1px 1px rgba(20, 20, 20, 0.7)' } },
	            name
	          ),
	          (0, _preact.h)(
	            'span',
	            { style: { fontSize: '1.2em', fontWeight: 100, textShadow: '1px 1px 1px rgba(20, 20, 20, 0.7)' } },
	            '\u201D',
	            tag,
	            '\u201D'
	          )
